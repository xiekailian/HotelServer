...
public class PersonPO implements Serializable {
	...
	public PersonPO(String username, String password, int personID, int credit,
			Calendar birthday, String vipType, int vipLevel,
			String enterpriseName, String phoneNumber) {
		super();
